...
p10<-DimPlot(combined.object.final, reduction = "umap", 
            group.by = "orig.ident",pt.size=0.1) + ggtitle("UMAP")
p10
...
sum(markers_high_vs_low$avg_log2FC < 0) 
sum(markers_high_vs_low$avg_log2FC > 0) 
...
up_markers <- markers_high_vs_low[markers_high_vs_low$p_val_adj < 0.05 & markers_high_vs_low$avg_log2FC > 0, ] %>% arrange(desc(avg_log2FC)) %>% slice(1:20) 
down_markers <- markers_high_vs_low[markers_high_vs_low$p_val_adj < 0.05 & markers_high_vs_low$avg_log2FC < 0, ] %>% arrange(avg_log2FC) %>% slice(1:20) 
...
DEG_genes = subset(markers_high_vs_low, p_val_adj < 0.05) 
...
selected_pathways <- c("regulation of T cell activation", "sulfur compound metabolic process", "activation of innate immune response", "glycoprotein metabolic process", "regulation of cell-cell adhesion" , "mononuclear cell differentiation" , "extrinsic apoptotic signaling pathway",
                       "positive regulation of cell activation", "cellular response to interleukin-1", "positive regulation of cellular amide metabolic process" , "positive regulation of leukocyte activation",
                       "alpha-beta T cell activation", "positive regulation of T cell activation", "immune response-activating signaling pathway", "immune response-activating cell surface receptor signaling pathway", "stress-activated MAPK cascade", "regulation of generation of precursor metabolites and energy")
...
#PGK1 gene
v1 <- VlnPlot(combined.object.final, features = "PGK1", group.by = "condition", pt.size = 0.1) + stat_compare_means(method.args = list(alternative = "two.sided")) + geom_boxplot(width = 0.4, size = 0.1)
v1
ggsave("./figures/Violinplot_PGK1_expression.pdf",v1, units = "cm", width = 15, height = 15)

#NFAT5 gene
v2 <- VlnPlot(combined.object.final, features = "NFAT5", group.by = "condition", pt.size = 0.1) + stat_compare_means(method.args = list(alternative = "two.sided")) + geom_boxplot(width = 0.4, size = 0.1)
...
#GLUD1 gene
v3 <- VlnPlot(combined.object.final, features = "GLUD1", group.by = "condition", pt.size = 0.1) + stat_compare_means(method.args = list(alternative = "two.sided")) + geom_boxplot(width = 0.4, size = 0.1)
v3
ggsave("./figures/Violinplot_GLUD1_expression.pdf",v3, units = "cm", width = 15, height = 15)


#ATP1B1 gene
v4 <- VlnPlot(combined.object.final, features = "ATP1B1", group.by = "condition", pt.size = 0.1) + stat_compare_means(method.args = list(alternative = "two.sided")) + geom_boxplot(width = 0.4, size = 0.1)
v4
...
#ATP1B3 gene
v5 <- VlnPlot(combined.object.final, features = "ATP1B3", group.by = "condition", pt.size = 0.1) + stat_compare_means(method.args = list(alternative = "two.sided")) + geom_boxplot(width = 0.4, size = 0.1)
v5
ggsave("./figures/Violinplot_ATP1B3_expression.pdf",v5, units = "cm", width = 15, height = 15)


#FXYD2 gene
v6 <- VlnPlot(combined.object.final, features = "FXYD2", group.by = "condition", pt.size = 0.1) + stat_compare_means(method.args = list(alternative = "two.sided")) + geom_boxplot(width = 0.4, size = 0.1)
v6
...
# CD5 gene
v4 <- VlnPlot(combined.object.final, features = "CD5", group.by = "condition", pt.size = 0.1) + stat_compare_means(method.args = list(alternative = "two.sided")) + geom_boxplot(width = 0.4, size = 0.1)
v4
...
p31 <- VlnPlot(object = combined.object.final, features = c("ICOS"), 
               group.by = "condition") +  scale_colour_gradientn(colours = rev(brewer.pal(n = 11, name = "RdBu"))) + stat_compare_means(method.args = list(alternative = "two.sided")) + geom_boxplot(width = 0.4, size = 0.1)
p31
ggsave("./figures/MA_Violinplot_ICOS_gene_high_vs_low_salt.pdf",p31, units = "cm", width = 13, height = 13)

#PDCD1
p32 <-  VlnPlot(combined.object.final, features = "PDCD1", group.by = "condition", pt.size = 0.1) + stat_compare_means(method.args = list(alternative = "two.sided")) + geom_boxplot(width = 0.4, size = 0.1)
p32
ggsave("./figures/MA_Violinplot_PDCD1_gene_high_vs_low_salt.pdf",p32, units = "cm", width = 13, height = 13)


#CTLA4
p33 <- VlnPlot(combined.object.final, features = "CTLA4", group.by = "condition", pt.size = 0.1) + stat_compare_means(method.args = list(alternative = "two.sided")) + geom_boxplot(width = 0.4, size = 0.1)
p33
